...
public class GraphComponent extends JComponent {
	...
	/**
	 * An inner class that represent a location of a node. Fields cX and cY are the center of the node,
	 * and fields tX and tY are the location where the label of the node is drawn. This is calculated
	 * for each node in the method {@code calculateNodeCoordinates()}
	 *
	 */
	private class Point {
		int cX;
	...
	/**
	 * width and height of the window when it was last resized. When change we recalculate the location
	 * of nodes to scale the graph, etc.
	 */
	...
	/**
	 * Draws a circle on the line from (x1,y1) to (x2,y2). Assuming the (virtual) length of the line is
	 * virtualLength, the circles is drawn at location virtualLocation (0..virtualLength). The diameter
	 * is 'diam'
	 */
	...
	/**
	 * Draws a line from (x1,y1) to (x2,y2) with an arrow of width d and height h. The color of the line
	 * is lineColor and that of the arrow is arrowColor.
	 */

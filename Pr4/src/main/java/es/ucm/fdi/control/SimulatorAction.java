...
/**
 * A simple action. Once created, can be added multiple times; and enabled and disabled at all
 * places at once.
 */
public class SimulatorAction extends AbstractAction {
	 ...
	 * 
	 * @param name
	 *            to use in menus (via toString), and as identifier when registering.
	 * @param iconName
	 *            used to locate an icon
	 * @param tooltip
	 *            to display when hovered-over
	 * @param mnemonic
	 *            for menus: a letter that will be underlined. Example: KeyEvent.VK_L is an 'l',

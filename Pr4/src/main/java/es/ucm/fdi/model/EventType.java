...
/**
 * clase enumerada en la que se detallan los tipos de eventos que nuestro único listener, MainWindow
 * puede recibir(entender la diferencia entre estos eventos y los eventos que se pasan al simulador)
 */

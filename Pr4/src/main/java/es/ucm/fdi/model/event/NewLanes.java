...
public class NewLanes extends NewRoad {
	...
	public NewLanes(int time, String id, String src, String dest, int maxSpeed,
	...
	public void execute(RoadMap simObjects) {
		...
		simObjects.addRoad(new Lanes(id, simObjects.getJunction(src),
				simObjects.getJunction(dest), maxSpeed, length, lanes));
	}
	...
	public class Builder implements Event.Builder {
		...
		public Event parse(IniSection sec) {
			if (!sec.getTag().equals("new_road")
				...
				return null;
			return new NewLanes(parseInt(sec, "time", 0),
